...
public class ListTester {
	...
	public static void main(String[] args) {
		...
		ObjectList<Worker> ourUnion = new ObjectList<Worker>();
		...
		ObjectList<GroceryItem> groceryList = new ObjectList<GroceryItem>();
		...
		GroceryItem someItem = groceryList.getPosition(3);

		System.out.println("Item 3 is " + someItem);
		
		System.out.println("Use the new style 'for each' loop");
		
		for(GroceryItem anItem : groceryList) {
